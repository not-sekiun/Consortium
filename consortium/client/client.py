...
class Client:
    ...
    async def run_client(self):
        ...
        while True:
            ...
            if isinstance(interpreter_return_status, SwitchInterpreterReturnStatus):
                ...
                current_interpreter = interpreter_class(client_session=client_session)
                ...
                current_interpreter = HomeInterpreter(client_session=client_session)
