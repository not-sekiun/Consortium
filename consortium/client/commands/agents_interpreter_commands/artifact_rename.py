...
class ArtifactRenameCommand(BaseConnectedCommand):
    name = "ar-rename"
    description = "Set the name of an artifact by its resource ID"
    epilog = format_argparse_epilog(
        """
        Examples:
          ar-rename 123e4567-e89b-12d3-a456-42661417400 "New name"
        """,
    )
