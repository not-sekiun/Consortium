...
class PayloadRenameCommand(BaseConnectedCommand):
    name = "pl-rename"
    description = "Set the name of a payload by its resource ID"
    epilog = format_argparse_epilog(
        """
        Examples:
          pl-rename 123e4567-e89b-12d3-a456-42661417400 "New name"
        """,
    )
