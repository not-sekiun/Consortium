...
class UnsetListenerTemplateOptionCommand(BaseCommand):
    name = "unset_listener_template_option"
    description = (
        "Unset a listener template option for the currently selected listener template "
        "being used."
    )
