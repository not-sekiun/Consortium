...
CONSORTIUM_FRAMEWORK_DIRECTORY_PATH = (
    CONSORTIUM_HOME_DIRECTORY_PATH / "consortium" / "framework"
)
CONSORTIUM_LISTENERS_DIRECTORY_PATH = CONSORTIUM_FRAMEWORK_DIRECTORY_PATH / "listeners"
CONSORTIUM_AGENTS_DIRECTORY_PATH = CONSORTIUM_FRAMEWORK_DIRECTORY_PATH / "agents"
CONSORTIUM_PLUGINS_DIRECTORY_PATH = CONSORTIUM_FRAMEWORK_DIRECTORY_PATH / "plugins"
CONSORTIUM_EVENT_HOOKS_DIRECTORY_PATH = (
    CONSORTIUM_FRAMEWORK_DIRECTORY_PATH / "event_hooks"
)
