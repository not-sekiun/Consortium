...
class AgentProfileLoaderService(ComponentLoaderService[BaseAgentTemplate]):
    ...
    def _assemble_component(
        ...
        # here would call the string itself. The generator derives its agent type and
        # compatible listener types from its creating template, so no class writes here.
